...
int main() {
    ...
    str = format("fill_, align 左对齐, width = 10, string = |{:_<10}|", 42);
    cout << str << endl;
    str = format("fill_, align 居中, width = 10, string = |{:_^10}|", 42);
    cout << str << endl;
    str = format("fill_, align 右对齐, width = 10, string = |{:_^10}|", 42);
    cout << str << endl;
    ...
    str = vformat(fmt, make_format_args(pi, 5, 10));
    cout << str << endl;
    return 0;
}